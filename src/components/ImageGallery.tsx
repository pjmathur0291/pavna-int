...
import Image4 from "../assets/images/Home/DSC08985.JPG.webp";
import Image5 from "../assets/images/Home/DSC08232.webp";
const STAGES = [
  {
    id: "early-years",
    title: "Early Years",
...
export default function ImageGallery() {
  ...
  return (
    <section
      id="stages-gallery"
      className="relative w-full h-auto md:h-[900px] overflow-hidden bg-brand-navy flex flex-row"
    >
        ...
        {STAGES.map((stage, i) => (
          <div
            ...
            className={cn(
              ...
              activeIdx === i
                ? "aspect-square md:aspect-auto md:flex-[2] bg-brand-navy/0"
                : "h-20 md:h-full md:flex-1 bg-black/40 hover:bg-black/20",
            )}
          >
            ...
            <div className="absolute inset-0 overflow-hidden bg-brand-navy">
              <img
                ...
                className={cn(
                  ...
                  activeIdx === i
                    ...
                    : "grayscale brightness-50 opacity-40 group-hover:scale-102 group-hover:opacity-55",
                )}
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, rgba(32, 26, 91, 0.65) 0%, rgba(32, 26, 91, 0) 100%)",
                }}
              />
            </div>
            ...
            <div
              className={cn(
                ...
                activeIdx === i
                  ? "bottom-0 p-5 sm:p-8 md:p-12"
                  : "top-0 p-4 md:p-12 h-full flex items-center",
              )}
            >
                ...
                >
                  ...
                  <h3
                    className={cn(
                      ...
                      activeIdx === i
                        ? "text-lg sm:text-xl md:text-3xl lg:text-4xl mb-2 md:mb-6"
                        : "mb-0",
                    )}
                  >
                    {stage.title}
