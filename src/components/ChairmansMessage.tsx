...
import Image1 from "../assets/images/Home/image_40.webp";
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80 leading-relaxed font-light font-gill max-w-2xl">
              Inspiring minds, building values, and nurturing global leaders who
              remain firmly anchored in character.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 lg:items-stretch items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              ...
              <div className="space-y-6 text-[#4B5563] text-[16px] leading-[24px] font-medium font-gill">
                <p>
                  Pavna international School represents our commitment to making
                  world-class education accessible to every aspiring student.
                  With our dynamic and adaptable Cambridge Curriculum, our goal
                  is to develop students who are not just learners but
                  innovators, capable of applying their knowledge in real-world
                  scenarios. We strive to instil in them a deep understanding of
                  our cultural values while exposing them to global
                  perspectives, preparing them to thrive as global citizens.
                </p>
                <p>
                  In an ever-evolving world, our students are groomed to be
                  leaders of change, not just adapting to it but driving it
                  forward. They will be the catalysts who inspire and empower
                  others to embrace and lead change, shaping a brighter future
              ...
              <div className="p-6 bg-[#FAF9F5] rounded-2xl border border-neutral-200/60 shadow-sm flex items-start gap-4 hover:border-brand-orange/30 transition-all duration-300">
                ...
                <p className="text-brand-navy text-[16px] font-serif font-bold italic leading-relaxed mb-0">
                  Our goal is to develop students who are not just learners but
                  innovators, capable of applying their knowledge in real-world
                  scenarios
                </p>
              </div>
