...
import Image2 from "../assets/images/Home/image_40.webp";
import Image3 from "../assets/images/Home/image_46.webp";
import Image4 from "../assets/images/Home/image_47.webp";
import Image5 from "../assets/images/Home/image_53.webp";
...
const LEADERSHIP_DATA = [
  {
    ...
    description:
      "Guided by purpose and legacy, Pavna Group continues to shape future leaders through world-class infrastructure, international faculty, and a commitment to surpassing conventional academic boundaries.",
  ...
  },
  {
    ...
    description:
      "Nurturing innovators through a dynamic Cambridge curriculum, rooted in cultural values and global perspectives preparing students to lead and drive change worldwide.",
  ...
  },
  {
    ...
    description:
      "Championing collaborative education through teachers, parents, and community fostering interactive learning and a lifelong passion for knowledge at PIS.",
  ...
  },
  {
    ...
    description:
      "Blending Cambridge curriculum, cultural values, and Apple-enabled technology to empower every student to chart their own unique path guided by the spirit of 'Be Yourself'.",
  ...
  },
  {
    ...
    description:
      "Balancing rigorous Cambridge academics with sports, arts, and experiential learning celebrating individuality and empowering every student.",
    name: "Ms. Aarti Nigam",
    title: "Principal",
    institution: "Pavna International School (PIS)",
    image: Image5,
...
export default function LeadershipSlider() {
  ...
  const nextSlide = () =>
    setActiveIndex((prev) => (prev + 1) % LEADERSHIP_DATA.length);
  const prevSlide = () =>
    setActiveIndex(
      (prev) => (prev - 1 + LEADERSHIP_DATA.length) % LEADERSHIP_DATA.length,
    );
    ...
    <section className="bg-brand-navy py-16 md:py-24 px-4 sm:px-8 md:px-16 overflow-hidden min-h-0 flex items-center font-gill">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-12 items-center">
        ...
        <div className="lg:col-span-12 xl:col-span-5 text-white">
          <span className="text-xs uppercase tracking-widest font-bold text-[#ffca05] mb-4 block">
            Leadership & Vision
          </span>
          <h2 className="text-[26px] sm:text-[34px] md:text-[42px] lg:text-[42px] leading-tight md:leading-[50px] font-bold mb-4">
            ...
            <span className="text-white">& honest experiences</span>{" "}
            <br className="hidden md:block" />
            shared by our leaders.
          </h2>
          <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-2 xl:mb-8 max-w-md">
            Our governing body, administration, and advisory panel share the
            core philosophies, strategic insights, and institutional milestones
            that define our educational blueprint.
          </p>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-6 sm:p-10 md:p-12 flex flex-col justify-center">
                <Quote
                  className="text-[#f48120] mb-4 md:mb-6"
                  size={40}
                  fill="currentColor"
                />
              ...
              <div className="w-full md:w-1/2 relative bg-gray-100 min-h-[300px] sm:min-h-[350px] md:min-h-0 h-[320px] md:h-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div>
                    ...
                    <p className="text-xs uppercase tracking-widest font-bold text-brand-sky mb-3">
                      {current.title}
                    </p>
                    ...
                    {(current.recognition || current.institution) && (
                      <div className="pt-4 border-t border-white/20 space-y-3">
                        {current.recognition && (
                          <div>
                            <p className="text-[9px] uppercase tracking-widest font-bold text-white/50 mb-0.5">
                              Recognition
                            </p>
              ...
              {LEADERSHIP_DATA.map((item, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeIndex === index
                      ? "border-brand-orange scale-110 z-10"
