        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { name: "Physical Development", image: "https://i.postimg.cc/5y2ScY24/shoes.png", desc: "Strengthening fine and gross motor movements through creative and active play." },
                { name: "Language and Communication Development", image: "https://i.postimg.cc/gj2H9X2k/message.png", desc: "Building rich vocabulary, reading familiarity, and self-expression skills." },
                { name: "Cognitive Development", image: "https://i.postimg.cc/fyRf4tRD/brain.png", desc: "Enabling structured thinking, observation, scientific inquiry, and logical reasoning." },
                { name: "Social and Emotional Development", image: "https://i.postimg.cc/fyRf4tRW/heart.png", desc: "Cultivating self-awareness, personal values, emotional control, and friendships." }
              ].map((area, i) => {
                return (
                  <motion.div
                    key={area.name}
