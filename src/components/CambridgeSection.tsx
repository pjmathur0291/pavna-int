...
import Image1 from "../assets/images/Home/image_63.webp";
const ADVANTAGES = [
  {
...
export default function CambridgeSection() {
  return (
    <section
      ...
      className="py-20 md:py-28 bg-white px-6 sm:px-8 md:px-16 overflow-hidden font-gill text-black"
    >
          ...
          >
            <div className="flex flex-col items-start w-fit max-w-full">
              ...
              <h2 className="text-[28px] sm:text-[36px] md:text-[42px] lg:text-[42px] leading-[34px] sm:leading-[44px] md:leading-[50px] tracking-[-1.2px] font-bold text-brand-navy font-serif text-left">
                ...
                <span className="text-brand-orange">Education</span>
              </h2>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 mb-4 sm:mb-6">
              ...
              <p className="text-[15px] sm:text-[16px] text-neutral-600 leading-relaxed sm:leading-[24px] font-medium font-gill">
                The Cambridge curriculum helps students build a strong academic
                foundation while preparing them for future success through
                globally recognized learning standards.
              </p>
            </div>
